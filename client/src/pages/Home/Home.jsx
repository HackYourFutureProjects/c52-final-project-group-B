...
const Home = () => {
  return (
    <>
      ...
      <div className="bg-default-300 container mx-auto mt-20 flex flex-col items-center gap-8 overflow-hidden rounded-[35px] p-8 text-center">
      ...
      <div className="container mx-auto my-20 flex flex-col gap-8 text-center">
